...
@supports (font-size: clamp(1.5rem, 4.2vw, 2.4rem)) {
  .section-title {
...
@media (min-width: 769px) {
  ...
  .education-card {
    ...
    -moz-box-shadow: 0 25px 50px rgba(0, 0, 0, 0.6);
...
@media (min-width: 481px) and (max-width: 768px) {
  ...
  .edu-line .edu-dot {
    ...
    -moz-box-shadow: 0 2px 8px rgba(34, 197, 94, 0.4);
...
@media (max-width: 480px) {
  ...
  .edu-line .edu-dot {
    ...
    -o-transition: left 0.35s ease;
    transition: left 0.35s ease;
    -webkit-box-shadow: 0 2px 6px rgba(34, 197, 94, 0.4);
    -moz-box-shadow: 0 2px 6px rgba(34, 197, 94, 0.4);
